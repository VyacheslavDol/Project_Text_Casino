...
#define MAX_SYMBOLS_BET 5   // MAX BET = 9999
...
typedef struct 
{
    short rank;     // Ранг: 1 = Туз, 2 = 2, ..., 10 = 10, 11 = Валет, 12 = Дама, 13 = Король
    short suit;     // Масть: 0 = Черви, 1 = Бубны, 2 = Трефы, 3 = Пики
} card_t;
...
{   
    ...
    int access[NUM_ROOM];
    int choice_room;
    int flag; // 0 - ... 1 - в случае если выбранная комната недоступна(нет мест \ идет игра)
} msg_info_room;
